...
Manage Facebook and Instagram ads from Claude Code, Codex, or another MCP-compatible assistant.

**77 tools** help you review performance, create reports, manage campaigns and ads, upload media,
...
Measured on macOS arm64 on August 20, 2026. Startup uses warm-run medians; loading tool definitions
...
or an extracted [source release](https://github.com/EfrainTorres/armavita-meta-ads-mcp/releases/tag/v2.0.0-rc.1):
